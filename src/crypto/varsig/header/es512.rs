...
impl<C: TryFrom<u32>> TryFrom<&[u8]> for Es512Header<C> {
    type Error = (); // FIXME
...
impl<C: Into<u32>> From<Es512Header<C>> for Vec<u8> {
...
impl<C: Codec + Into<u32> + TryFrom<u32>> Header<C> for Es512Header<C> {
