...
The main way to get help is on our [discord server](https://discord.gg/4UdeQhw7fv).
...
need to be the best programmer to contribute. Our discord is open for questions.
 ...
 6. **Build** the project
    - For a detailed look on how to build rs_ucan look at our
